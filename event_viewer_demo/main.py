...
async def receive_event(event: EventReceive):
    ...
    try:
        ...
        # Salvar a imagem do evento com a bounding box
...
async def clear_events():
    ...
    # Opcional: remover imagens salvas
...
# Template para página de detalhes do evento
event_detail_html = """
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    <div class="container">
        <div class="detail-container">
            <img src="/{{ event.image_path }}" alt="Evento {{ event.id }}" class="detail-image">
